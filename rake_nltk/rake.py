...
class Rake(object):
    ...
    def extract_keywords_from_text(self, text):
        ...
        # sentences = nltk.tokenize.sent_tokenize(text)
        # self.extract_keywords_from_sentences(text.split(' '))
        self.extract_keywords_from_sentences(text)
    ...
    def _build_ranklist(self, phrase_list):
        ...
        # self.rank_list.sort(reverse=False)
    ...
    def _generate_phrases(self, sentences):
        ...
        for sentence in sentences:
            # word_list = [word.lower() for word in twitter.morphs(sentence)]
            # word_list = [word.lower() for word in twitter.nouns(sentence)]
            # word_list = [word.lower() for word in twitter.nouns(sentence)]

            # word_list = [word.lower() for word in sentence.split(' ')]
            # from eunjeon import Mecab
            # tagger = Mecab()
            # word_list = [word.lower() for word in tagger.nouns(sentence)]
